...
class Rocket:
    def __init__(self, max_thrust, burn_time, drag_coefficient, cross_sec_area, dry_mass, propellant_mass):
...
def main():
    ...
    rocket = Rocket(dry_mass=29.9, propellant_mass=4.531, max_thrust=2891, burn_time=3.9, drag_coefficient=0.5, cross_sec_area=0.0193)
